...
--   1. profiles : un pseudo public par utilisateur (jamais l'email, qui
--      reste privé). Lecture ouverte à tous (un pseudo n'a rien de
--      sensible), écriture réservée à son propre profil.
...
-- handle_new_user (005/012, qui crée la ligne portfolio) plutôt que fusionné
-- dedans, pour garder chaque trigger responsable d'une seule table.
