...
// 1 K¢ fictif = 50 000 € de pouvoir d'investissement réel simulé. Avec les
// 10 000 K¢ de départ (voir lib/market.js STARTING_CASH), ça donne un pouvoir
// d'investissement total de 500 M€ par utilisateur — cohérent avec le fait de
// pouvoir prendre une position (même minoritaire) sur des startups valorisées
// plusieurs milliards d'euros.
export const EUR_PER_KC = 50_000;
